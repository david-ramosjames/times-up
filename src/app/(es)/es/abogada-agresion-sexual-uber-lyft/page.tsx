...
export const metadata: Metadata = {
  title: "Abogada de Agresión Sexual en Uber y Lyft en Texas",
  description:
  ...
  alternates: {
    canonical: `${SITE_URL}/es/abogada-agresion-sexual-uber-lyft`,
    languages: {
      en: `${SITE_URL}/rideshare-sexual-assault-lawyer`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-uber-lyft`,
    },
  },
  openGraph: {
    title: "Abogada de Agresión Sexual en Uber y Lyft en Texas",
    description:
      "¿Fue agredida por un conductor de Uber, Lyft o un repartidor en Texas? Nuestro bufete liderado por mujeres exige cuentas a las plataformas. Revisión de caso gratis y confidencial.",
    url: `${SITE_URL}/es/abogada-agresion-sexual-uber-lyft`,
  },
};

export default function RidesharePageES() {
  const dict = getDictionary("es");
  const d = dict.rideshare;
  const routes = ROUTES.es;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={localBusinessSchema("es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: d.title, url: "/es/abogada-agresion-sexual-uber-lyft" }])} />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-6 overflow-hidden rounded-xl">
            <Image
              src={IMAGES.practice.rideshare}
              alt="Auto de transporte por aplicación con marcador de ubicación"
              width={800}
              height={450}
      ...
      <section className="py-10">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link href={routes.hotelAssault} className="text-brand-red underline hover:text-brand-red-dark">Abogada de Agresión en Hoteles y Seguridad Negligente</Link>
