...
export const metadata: Metadata = {
  title: "¿Tengo un Caso? Reclamos Civiles para Sobrevivientes en Texas",
  description:
    "¿Se pregunta si tiene un caso civil después de una agresión o abuso sexual en Texas? Conozca quién puede ser responsabilizado y cuáles son sus opciones. Consulta confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/tengo-un-caso`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/do-i-have-a-case`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/tengo-un-caso`,
    },
  },
};
...
export default function QAPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/tengo-un-caso` }])} />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 space-y-3">
              {d.questions.filter((_, i) => i !== 0).slice(0, 4).map((related) => (
