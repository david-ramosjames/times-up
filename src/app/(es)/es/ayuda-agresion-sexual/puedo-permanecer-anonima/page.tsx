...
export const metadata: Metadata = {
  title: "¿Puedo Permanecer Anónima? Demandar como Jane Doe",
  description:
    "En muchos casos en Texas puede demandar bajo un seudónimo como 'Jane Doe'. Conozca cómo protegemos su identidad en cada etapa. Consulta confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/puedo-permanecer-anonima`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/can-i-stay-anonymous`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/puedo-permanecer-anonima`,
    },
  },
};
...
export default function QAPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/puedo-permanecer-anonima` }])} />
