...
export const metadata: Metadata = {
  title: "Caso Civil vs. Caso Penal: ¿Cuál Es la Diferencia?",
  description:
    "Un caso penal busca castigo; un caso civil le da a usted compensación y control. Son independientes y usan estándares distintos. Conozca sus opciones. Consulta confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/caso-civil-vs-penal`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/civil-vs-criminal-case`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/caso-civil-vs-penal`,
    },
  },
};
...
export default function QAPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/caso-civil-vs-penal` }])} />
