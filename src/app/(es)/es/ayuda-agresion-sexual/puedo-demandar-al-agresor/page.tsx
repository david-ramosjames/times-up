...
export const metadata: Metadata = {
  title: "¿Puedo Demandar a la Persona Que Me Agredió?",
  description:
    "Sí: la ley de Texas permite demandar directamente a su agresor, aunque nunca hubiera cargos penales. Conozca sus derechos civiles. Consulta gratis y confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/puedo-demandar-al-agresor`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/can-i-sue-my-abuser`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/puedo-demandar-al-agresor`,
    },
  },
};
...
export default function QAPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/puedo-demandar-al-agresor` }])} />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 space-y-3">
              {d.questions.filter((_, i) => i !== 1).slice(0, 4).map((related) => (
