...
export const metadata: Metadata = {
  title: "¿Qué Compensación Puedo Recibir?",
  description:
    "Terapia, atención médica, ingresos perdidos, dolor y sufrimiento, y daños punitivos en casos graves. Conozca lo que la ley de Texas permite recuperar. Consulta confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/que-compensacion-puedo-recibir`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/what-compensation-can-i-recover`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/que-compensacion-puedo-recibir`,
    },
  },
};
...
export default function QAPageES() {
  ...
  const q = d.questions[7];
  const routes = ROUTES.es;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={localBusinessSchema("es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/que-compensacion-puedo-recibir` }])} />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 space-y-3">
              {d.questions.filter((_, i) => i !== 7).slice(0, 4).map((related) => (
