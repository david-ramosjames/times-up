...
export const metadata: Metadata = {
  title: "¿Cuánto Vale Mi Caso de Agresión Sexual?",
  description:
    "El valor depende del daño, la evidencia y quién puede ser responsabilizado. Los casos contra instituciones negligentes suelen ser sustanciales. Evaluación confidencial gratis.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/cuanto-vale-mi-caso`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/how-much-is-my-case-worth`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/cuanto-vale-mi-caso`,
    },
  },
};
...
export default function QAPageES() {
  ...
  const q = d.questions[6];
  const routes = ROUTES.es;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={localBusinessSchema("es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/cuanto-vale-mi-caso` }])} />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 space-y-3">
              {d.questions.filter((_, i) => i !== 6).slice(0, 4).map((related) => (
