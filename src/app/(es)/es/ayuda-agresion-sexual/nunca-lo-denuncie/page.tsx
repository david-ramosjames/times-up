...
export const metadata: Metadata = {
  title: "¿Y Si Nunca Lo Denuncié a la Policía?",
  description:
    "Aun sin denuncia policial puede presentar un caso civil en Texas. La mayoría de las agresiones nunca se denuncian y los tribunales lo entienden. Consulta confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/nunca-lo-denuncie`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/what-if-i-never-reported`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/nunca-lo-denuncie`,
    },
  },
};
...
export default function QAPageES() {
  ...
  const q = d.questions[9];
  const routes = ROUTES.es;

  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={localBusinessSchema("es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/nunca-lo-denuncie` }])} />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 space-y-3">
              {d.questions.filter((_, i) => i !== 9).slice(0, 4).map((related) => (
