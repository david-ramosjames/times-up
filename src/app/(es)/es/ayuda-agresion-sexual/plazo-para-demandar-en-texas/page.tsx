...
export const metadata: Metadata = {
  title: "¿Cuánto Tiempo Tengo para Demandar? Plazos Legales en Texas",
  description:
    "Texas da hasta 5 años a muchas sobrevivientes adultas y hasta 30 años después de cumplir 18 en muchos casos de abuso infantil. Conozca sus plazos. Consulta confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/ayuda-agresion-sexual/plazo-para-demandar-en-texas`,
    languages: {
      en: `${SITE_URL}/sexual-assault-help/texas-statute-of-limitations`,
      es: `${SITE_URL}/es/ayuda-agresion-sexual/plazo-para-demandar-en-texas`,
    },
  },
};
...
export default function QAPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Ayuda para Sobrevivientes", url: "/es/ayuda-agresion-sexual" }, { name: q.fullTitle, url: `/es/ayuda-agresion-sexual/plazo-para-demandar-en-texas` }])} />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 space-y-3">
              {d.questions.filter((_, i) => i !== 2).slice(0, 4).map((related) => (
