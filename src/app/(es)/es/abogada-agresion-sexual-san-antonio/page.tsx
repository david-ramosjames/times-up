...
export const metadata: Metadata = {
  title: "Abogada de Agresión Sexual en San Antonio, TX",
  description:
    "¿Sobrevivió una agresión sexual en San Antonio? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/abogada-agresion-sexual-san-antonio`,
    languages: {
      en: `${SITE_URL}/sexual-assault-lawyer-san-antonio`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-san-antonio`,
    },
  },
  openGraph: {
    title: "Abogada de Agresión Sexual en San Antonio, TX",
    description:
      "¿Sobrevivió una agresión sexual en San Antonio? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
    url: `${SITE_URL}/es/abogada-agresion-sexual-san-antonio`,
  },
};
...
export default function SanAntonioPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "San Antonio", url: "/es/abogada-agresion-sexual-san-antonio" }])} />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Recursos de Apoyo en San Antonio</h3>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">
            Preguntas de Sobrevivientes: San Antonio
          </h2>
          <div className="mt-10">
