...
export const metadata: Metadata = {
  title: "Abogada de Agresión Sexual en Austin, TX",
  description:
    "¿Sobrevivió una agresión sexual en Austin? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/abogada-agresion-sexual-austin`,
    languages: {
      en: `${SITE_URL}/sexual-assault-lawyer-austin`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-austin`,
    },
  },
  openGraph: {
    title: "Abogada de Agresión Sexual en Austin, TX",
    description:
      "¿Sobrevivió una agresión sexual en Austin? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
    url: `${SITE_URL}/es/abogada-agresion-sexual-austin`,
  },
};

export default function AustinPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Austin", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Austin", url: "/es/abogada-agresion-sexual-austin" }])} />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Recursos de Apoyo en Austin</h3>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">
            Preguntas de Sobrevivientes: Austin
          </h2>
          <div className="mt-10">
      ...
      {/* Áreas cercanas */}
      <NearbyAreas currentCity="austin" locale="es" />
