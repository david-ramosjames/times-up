...
export const metadata: Metadata = {
  title: "Abogada de Agresión Sexual en Arlington, TX",
  description:
    "¿Sobrevivió una agresión sexual en Arlington? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/abogada-agresion-sexual-arlington`,
    languages: {
      en: `${SITE_URL}/sexual-assault-lawyer-arlington`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-arlington`,
    },
  },
  openGraph: {
    title: "Abogada de Agresión Sexual en Arlington, TX",
    description:
      "¿Sobrevivió una agresión sexual en Arlington? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
    url: `${SITE_URL}/es/abogada-agresion-sexual-arlington`,
  },
};

export default function ArlingtonPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Arlington", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Arlington", url: "/es/abogada-agresion-sexual-arlington" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.arlington} alt="Mapa del área de Arlington" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Recursos de Apoyo en Arlington</h3>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">
            Preguntas de Sobrevivientes: Arlington
          </h2>
          <div className="mt-10">
      ...
      {/* Áreas cercanas */}
      <NearbyAreas currentCity="arlington" locale="es" />
