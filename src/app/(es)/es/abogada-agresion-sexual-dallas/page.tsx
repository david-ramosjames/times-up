...
export const metadata: Metadata = {
  title: "Abogada de Agresión Sexual en Dallas, TX",
  description:
    "¿Sobrevivió una agresión sexual en Dallas? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/abogada-agresion-sexual-dallas`,
    languages: {
  ...
  openGraph: {
    ...
    description:
      "¿Sobrevivió una agresión sexual en Dallas? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
    url: `${SITE_URL}/es/abogada-agresion-sexual-dallas`,
  },
};

export default function DallasPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("Dallas", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "Dallas", url: "/es/abogada-agresion-sexual-dallas" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.dallas} alt="Mapa del área de Dallas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Recursos de Apoyo en Dallas</h3>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">
            Preguntas de Sobrevivientes: Dallas
          </h2>
          <div className="mt-10">
      ...
      {/* Áreas cercanas */}
      <NearbyAreas currentCity="dallas" locale="es" />
