...
export const metadata: Metadata = {
  title: "Abogada de Agresión Sexual en El Paso, TX",
  description:
    "¿Sobrevivió una agresión sexual en El Paso? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
  alternates: {
    canonical: `${SITE_URL}/es/abogada-agresion-sexual-el-paso`,
    languages: {
      en: `${SITE_URL}/sexual-assault-lawyer-el-paso`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-el-paso`,
    },
  },
  openGraph: {
    title: "Abogada de Agresión Sexual en El Paso, TX",
    description:
      "¿Sobrevivió una agresión sexual en El Paso? Times Up acompaña a las sobrevivientes frente a agresores e instituciones negligentes. Consulta gratis y confidencial.",
    url: `${SITE_URL}/es/abogada-agresion-sexual-el-paso`,
  },
};

export default function ElPasoPageES() {
  ...
  return (
    <PageShell dict={dict} locale="es">
      <JsonLd data={cityLegalServiceSchema("El Paso", "TX", "es")} />
      <JsonLd data={breadcrumbSchema([{ name: "Inicio", url: "/es" }, { name: "Áreas que Servimos", url: "/es/areas-que-servimos" }, { name: "El Paso", url: "/es/abogada-agresion-sexual-el-paso" }])} />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Recursos de Apoyo en El Paso</h3>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">
            Preguntas de Sobrevivientes: El Paso
          </h2>
          <div className="mt-10">
      ...
      {/* Áreas cercanas */}
      <NearbyAreas currentCity="elPaso" locale="es" />
