...
export const metadata: Metadata = {
  title: "Can I Stay Anonymous? Jane Doe Lawsuits in Texas",
  description:
    "Texas courts often let survivors file as 'Jane Doe' to protect their identity. Learn how anonymity and privacy protections work in civil cases.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/can-i-stay-anonymous`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/can-i-stay-anonymous` }])} />
