...
export const metadata: Metadata = {
  title: "Survivor Help Center: Texas Sexual Assault Lawyers",
  description:
    "Honest answers for survivors of sexual assault and abuse in Texas. Learn your civil rights, deadlines, and options — confidentially. Free consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help`,
    languages: {
  ...
  openGraph: {
    title: "Survivor Help Center: Texas Sexual Assault Lawyers",
    description:
      "Honest answers for survivors of sexual assault and abuse in Texas. Learn your civil rights, deadlines, and options — confidentially.",
    url: `${SITE_URL}/sexual-assault-help`,
  },
};

export default function SurvivorHelpPage() {
    ...
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd
        data={breadcrumbSchema([
          { name: "Home", url: "/" },
          { name: "Survivor Help", url: "/sexual-assault-help" },
        ])}
      />
      <JsonLd
        data={faqSchema(
      ...
      {/* What Makes Civil Survivor Cases Different */}
      ...
      {/* Common Survivor Questions: Hub Links */}
      <section className="py-16">
