...
export const metadata: Metadata = {
  title: "What If I Never Reported It to the Police?",
  description:
    "You can still bring a civil case in Texas — a police report is not required, and most assaults are never reported. Learn your options confidentially.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/what-if-i-never-reported`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/what-if-i-never-reported` }])} />
