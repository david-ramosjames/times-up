...
export const metadata: Metadata = {
  ...
  description:
    "The value of a survivor's civil case depends on the harm, the evidence, and who can be held accountable. Get an honest, confidential evaluation — free.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/how-much-is-my-case-worth`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/how-much-is-my-case-worth` }])} />
