...
export const metadata: Metadata = {
  title: "What Compensation Can Survivors Recover in Texas?",
  description:
    "Therapy costs, lost income, pain and suffering, punitive damages — learn what Texas civil law allows survivors to recover. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/what-compensation-can-i-recover`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/what-compensation-can-i-recover` }])} />
