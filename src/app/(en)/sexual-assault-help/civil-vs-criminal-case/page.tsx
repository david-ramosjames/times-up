...
export const metadata: Metadata = {
  title: "Civil Case vs. Criminal Case: What Survivors Should Know",
  description:
    "A civil case is yours — separate from any criminal case, with a lower burden of proof and compensation for the harm. Learn the differences.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/civil-vs-criminal-case`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/civil-vs-criminal-case` }])} />
