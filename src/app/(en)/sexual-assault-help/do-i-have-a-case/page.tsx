...
export const metadata: Metadata = {
  title: "Do I Have a Case? Civil Claims for Survivors in Texas",
  description:
    "Wondering if you have a civil case after sexual assault or abuse in Texas? Learn who can be held accountable and what your options are. Confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/do-i-have-a-case`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/do-i-have-a-case` }])} />
