...
export const metadata: Metadata = {
  title: "Can I Sue a Hotel, Employer, or School for Sexual Assault?",
  description:
    "Institutions whose negligence enabled an assault — hotels, employers, schools, platforms — can be held liable in Texas. Learn how. Confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/can-i-sue-an-institution`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/can-i-sue-an-institution` }])} />
