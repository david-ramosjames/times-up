...
export const metadata: Metadata = {
  title: "Texas Statute of Limitations for Sexual Assault Civil Claims",
  description:
    "How long do survivors have to file a civil lawsuit in Texas? Up to 5 years for many adult claims and 30 years for many childhood abuse claims. Learn more.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/texas-statute-of-limitations`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/texas-statute-of-limitations` }])} />
