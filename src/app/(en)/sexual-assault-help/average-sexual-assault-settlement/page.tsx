...
export const metadata: Metadata = {
  title: "What's the Average Settlement in a Sexual Assault Case?",
  description:
    "There is no meaningful 'average' — outcomes depend on the harm, the defendants, and the evidence. Get an honest evaluation of your actual case, free.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/average-sexual-assault-settlement`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/average-sexual-assault-settlement` }])} />
      ...
      <section className="bg-brand-navy py-16 text-white">
        <div className="mx-auto max-w-3xl px-4">
          <nav className="mb-6 text-sm text-gray-400">
            ...
            <Link href="/sexual-assault-help" className="hover:text-white">Survivor Help</Link>
            <span className="mx-2">/</span>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-12 rounded-xl bg-brand-navy p-8 text-center text-white">
            <h2 className="text-2xl font-bold">Ready to Talk? We&rsquo;re Here.</h2>
            <p className="mt-2 text-gray-300">Get a free, confidential, no-obligation consultation with our team.</p>
          ...
          <div className="mt-12">
            ...
            <div className="mt-6">
              <Link href="/sexual-assault-help" className="inline-flex items-center gap-1 font-medium text-brand-coral hover:text-brand-rose">
