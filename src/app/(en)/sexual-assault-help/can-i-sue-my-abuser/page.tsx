...
export const metadata: Metadata = {
  title: "Can I Sue the Person Who Assaulted Me?",
  description:
    "Yes — Texas law lets survivors sue their attacker directly, even without criminal charges. Learn how civil claims work. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-help/can-i-sue-my-abuser`,
    languages: {
...
export default function QAPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Survivor Help", url: "/sexual-assault-help" }, { name: q.fullTitle, url: `/sexual-assault-help/can-i-sue-my-abuser` }])} />
