...
export const metadata: Metadata = {
  title: { absolute: "Times Up - Texas Sexual Assault Lawyers for Survivors" },
  description:
    "Survivor of sexual assault or abuse in Texas? Times Up is a woman-led firm fighting for survivors. Free, confidential case review. No fees unless we win.",
  alternates: {
    canonical: SITE_URL,
    languages: { en: SITE_URL, es: `${SITE_URL}/es` },
  },
  openGraph: {
    title: "Times Up - Texas Sexual Assault Lawyers for Survivors",
    description:
      "Survivor of sexual assault or abuse in Texas? Times Up is a woman-led firm fighting for survivors. Free, confidential case review. No fees unless we win.",
    url: SITE_URL,
  },
  ...
  return (
    <PageShell dict={dict} locale="en">
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-gray-600">
              Coming forward is hard. We make what follows clearer, safer, and never something you face alone.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              {
                title: "Survivor-Focused Practice",
                desc: "We handle sexual assault and abuse cases exclusively — with the sensitivity, privacy, and focus these cases demand.",
                icon: (
              ...
              },
              {
                ...
                desc: "We listen first, explain every option in plain language, and let you set the pace at every step.",
                icon: (
                  <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
              ...
              {
                title: "Full Accountability Mindset",
                desc: "We pursue the perpetrator and every negligent institution — therapy costs, lost income, pain, and long-term impact included.",
                icon: (
                  <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
          ...
          <div className="mt-10 text-center">
            ...
            >
              ...
              <span className="lg:hidden">Call Now — Confidential</span><span className="hidden lg:inline">{dict.cta.callNow}: {PHONE_DISPLAY}</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-brand-cream py-14 md:py-16">
        ...
        />
        {/* Warm violet glow behind the header */}
        <div
          aria-hidden
        ...
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="text-center">
            ...
            <h2 className="mt-3 text-3xl font-bold text-brand-navy md:text-4xl">
              Fighting for Full Accountability: Case by Case
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-gray-500 md:text-lg">
              Every case is different. But when institutions fail the people they were trusted to protect, we fight for the full measure of justice our clients deserve.
            </p>
          </div>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {[
              { amount: "Seven-Figure", label: "Settlement", title: "Hotel Negligent Security", detail: "Identity protected — Jane Doe filing" },
              { amount: "Seven-Figure", label: "Settlement", title: "Rideshare Driver Assault", detail: "Platform accountability claim" },
              { amount: "High Six-Figure", label: "Settlement", title: "Workplace Assault (Confidential)", detail: "Employer ignored prior complaints" },
            ].map((c) => (
              <div
                key={c.title}
          ...
          <p className="mt-10 text-center text-sm font-medium text-gray-600">
            + Additional confidential recoveries against hotels, employers, schools, and property owners
          </p>

          {/* Disclaimer */}
          <p className="mt-3 text-center text-xs text-gray-400">
            Results depend on the facts of each case. Not all cases result in the same outcome. Details are withheld to protect client privacy.
          </p>

          {/* CTA */}
          <div className="mt-12 text-center">
            <p className="mb-4 text-lg font-medium text-brand-navy">
              Find out what accountability could look like in your case
            </p>
            <a
              href={`tel:+1${PHONE_NUMBER}`}
            ...
            >
              ...
              <span className="lg:hidden">Call Now — Confidential</span><span className="hidden lg:inline">Call Now: {PHONE_DISPLAY}</span>
            </a>
          </div>
        </div>
      </section>
