...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Fort Worth, TX",
  description:
    "Survivor of sexual assault in Fort Worth? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-fort-worth`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-fort-worth`, es: `${SITE_URL}/es/abogada-agresion-sexual-fort-worth` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Fort Worth, TX",
    description:
    "Survivor of sexual assault in Fort Worth? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-fort-worth`,
  },
};
...
export default function FortWorthPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Fort Worth", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Fort Worth", url: "/sexual-assault-lawyer-fort-worth" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.fortWorth} alt="Fort Worth area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Fort Worth</h3>
      ...
      <NearbyAreas currentCity="fortWorth" locale="en" />
