...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Austin, TX",
  description:
    "Survivor of sexual assault in Austin? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-austin`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-austin`, es: `${SITE_URL}/es/abogada-agresion-sexual-austin` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Austin, TX",
    description:
    "Survivor of sexual assault in Austin? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-austin`,
  },
};

export default function AustinPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.austin;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Austin", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Austin", url: "/sexual-assault-lawyer-austin" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.cities.austin} alt="Austin, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.austin} alt="Austin area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>

      {/* Institutional failures & resources */}
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">
            Where Institutions Fail Survivors
          </h2>
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Austin</h3>
