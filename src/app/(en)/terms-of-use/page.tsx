...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms of Use for the Times Up website.",
};

const content: LegalBlock[] = [
  {
    "type": "p",
    "text": "These Terms of Use (\"Terms\") govern your access to and use of the website, forms, communication tools, content, and related online services provided by Times Up Law, PLLC (\"Times Up,\" \"Firm,\" \"we,\" \"us,\" or \"our\") (collectively, the \"Website\")."
  },
  {
    "type": "p",
  ...
  {
    "type": "p",
    "text": "Your use of this Website does not create an attorney-client relationship with Times Up Law, PLLC."
  },
  {
    "type": "p",
  ...
  {
    "type": "p",
    "text": "All content available through the Website, including text, graphics, logos, photographs, videos, designs, software, code, documents, and other materials, is owned by or licensed to Times Up Law, PLLC and is protected by applicable intellectual property laws."
  },
  {
    "type": "p",
  ...
  {
    "type": "p",
    "text": "TO THE FULLEST EXTENT PERMITTED BY LAW, TIMES UP LAW, PLLC DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF:"
  },
  {
    "type": "ul",
    "items": [
  ...
  {
    "type": "p",
    "text": "TO THE FULLEST EXTENT PERMITTED BY LAW, TIMES UP LAW, PLLC AND ITS ATTORNEYS, EMPLOYEES, CONTRACTORS, AGENTS, AND REPRESENTATIVES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL, EXEMPLARY, OR PUNITIVE DAMAGES ARISING OUT OF OR RELATED TO YOUR USE OF THE WEBSITE."
  },
  {
    "type": "p",
  ...
  {
    "type": "p",
    "text": "You agree to defend, indemnify, and hold harmless Times Up Law, PLLC and its attorneys, employees, agents, contractors, and representatives from and against any claims, damages, liabilities, costs, expenses, or attorney fees arising from:"
  },
  {
    "type": "ul",
    "items": [
