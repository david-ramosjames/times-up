...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Plano, TX",
  description:
    "Survivor of sexual assault in Plano? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-plano`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-plano`, es: `${SITE_URL}/es/abogada-agresion-sexual-plano` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Plano, TX",
    description:
    "Survivor of sexual assault in Plano? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-plano`,
  },
};

export default function PlanoPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.plano;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Plano", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Plano", url: "/sexual-assault-lawyer-plano" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.cities.plano} alt="Plano, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.plano} alt="Plano area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Plano</h3>
      ...
      <NearbyAreas currentCity="plano" locale="en" />
