...
export const metadata: Metadata = {
  title: "Survivor FAQ: Civil Sexual Assault Claims in Texas",
  description:
    "Answers to common questions about civil sexual assault and abuse claims in Texas, including confidentiality, deadlines, and compensation.",
  alternates: {
