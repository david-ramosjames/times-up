...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Lubbock, TX",
  description:
    "Survivor of sexual assault in Lubbock? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-lubbock`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-lubbock`, es: `${SITE_URL}/es/abogada-agresion-sexual-lubbock` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Lubbock, TX",
    description:
    "Survivor of sexual assault in Lubbock? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-lubbock`,
  },
};

export default function LubbockPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.lubbock;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Lubbock", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Lubbock", url: "/sexual-assault-lawyer-lubbock" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.cities.lubbock} alt="Lubbock, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.lubbock} alt="Lubbock area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Lubbock</h3>
      ...
      <NearbyAreas currentCity="lubbock" locale="en" />
