...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Houston, TX",
  description:
    "Survivor of sexual assault in Houston? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-houston`,
    languages: {
      en: `${SITE_URL}/sexual-assault-lawyer-houston`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-houston`,
    },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Houston, TX",
    description:
    "Survivor of sexual assault in Houston? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-houston`,
  },
};

export default function HoustonPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.houston;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Houston", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Houston", url: "/sexual-assault-lawyer-houston" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.houston} alt="Houston area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Houston</h3>
      ...
      {/* Nearby Areas */}
      <NearbyAreas currentCity="houston" locale="en" />
