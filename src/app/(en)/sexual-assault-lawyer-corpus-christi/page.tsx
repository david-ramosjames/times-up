...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Corpus Christi, TX",
  description:
    "Survivor of sexual assault in Corpus Christi? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-corpus-christi`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-corpus-christi`, es: `${SITE_URL}/es/abogada-agresion-sexual-corpus-christi` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Corpus Christi, TX",
    description:
    "Survivor of sexual assault in Corpus Christi? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-corpus-christi`,
  },
};

export default function CorpusChristiPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.corpusChristi;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Corpus Christi", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Corpus Christi", url: "/sexual-assault-lawyer-corpus-christi" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.corpusChristi} alt="Corpus Christi area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Corpus Christi</h3>
      ...
      <NearbyAreas currentCity="corpusChristi" locale="en" />
