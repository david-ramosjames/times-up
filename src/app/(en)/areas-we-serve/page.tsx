...
export const metadata: Metadata = {
  title: "Areas We Serve: Texas Sexual Assault Lawyers",
  description:
...
export default function AreasPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <section className="bg-white py-12">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mt-4 text-sm text-brand-steel">
            We represent survivors in every highlighted city and throughout Texas.
          </p>
        </div>
      </section>
      ...
      {/* Where Institutional Negligence Shows Up */}
