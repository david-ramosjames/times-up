...
export const metadata: Metadata = {
  title: "Workplace Sexual Assault Lawyer in Texas",
  description:
  ...
  alternates: {
    canonical: `${SITE_URL}/workplace-sexual-assault-lawyer`,
    languages: {
      en: `${SITE_URL}/workplace-sexual-assault-lawyer`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-trabajo`,
    },
  },
};

export default function WorkplaceAssaultPage() {
  const dict = getDictionary("en");
  const d = dict.workplaceAssault;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={localBusinessSchema("en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: d.title, url: "/workplace-sexual-assault-lawyer" }])} />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-6 overflow-hidden rounded-xl">
            <Image
              src={IMAGES.practice.workplace}
              alt="Briefcase with protective shield — workplace safety"
              width={800}
              height={450}
      ...
      <section className="py-10">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link href={routes.hotelAssault} className="text-brand-red underline hover:text-brand-red-dark">Hotel &amp; Negligent Security Lawyer</Link>
