...
export const metadata: Metadata = {
  title: "Uber & Lyft Sexual Assault Lawyer in Texas",
  description:
  ...
  alternates: {
    canonical: `${SITE_URL}/rideshare-sexual-assault-lawyer`,
    languages: {
...
export default function RidesharePage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: d.title, url: "/rideshare-sexual-assault-lawyer" }])} />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-6 overflow-hidden rounded-xl">
            <Image
              ...
              alt="Rideshare car with location pin"
              width={800}
              height={450}
