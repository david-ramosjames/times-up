...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Arlington, TX",
  description:
    "Survivor of sexual assault in Arlington? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-arlington`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-arlington`, es: `${SITE_URL}/es/abogada-agresion-sexual-arlington` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Arlington, TX",
    description:
    "Survivor of sexual assault in Arlington? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-arlington`,
  },
};

export default function ArlingtonPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.arlington;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Arlington", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Arlington", url: "/sexual-assault-lawyer-arlington" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.cities.arlington} alt="Arlington, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.arlington} alt="Arlington area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Arlington</h3>
      ...
      <NearbyAreas currentCity="arlington" locale="en" />
