...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer`,
    languages: {
  ...
  openGraph: {
    title: "Texas Sexual Assault Lawyer",
    description:
      "Survivor of sexual assault in Texas? Our woman-led firm pursues civil justice against attackers and negligent institutions.",
    url: `${SITE_URL}/sexual-assault-lawyer`,
  },
};
    ...
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd
        data={breadcrumbSchema([
          { name: "Home", url: "/" },
          { name: d.title, url: "/sexual-assault-lawyer" },
        ])}
      />
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-6 overflow-hidden rounded-xl">
            <Image
              ...
              alt="Scales of justice — civil claims for survivors"
              width={800}
              height={450}
