...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in El Paso, TX",
  description:
    "Survivor of sexual assault in El Paso? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-el-paso`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-el-paso`, es: `${SITE_URL}/es/abogada-agresion-sexual-el-paso` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in El Paso, TX",
    description:
    "Survivor of sexual assault in El Paso? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-el-paso`,
  },
};

export default function ElPasoPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.elPaso;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("El Paso", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "El Paso", url: "/sexual-assault-lawyer-el-paso" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.cities.elPaso} alt="El Paso, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.elPaso} alt="El Paso area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in El Paso</h3>
      ...
      <NearbyAreas currentCity="elPaso" locale="en" />
