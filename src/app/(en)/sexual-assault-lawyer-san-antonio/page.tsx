...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in San Antonio, TX",
  description:
    "Survivor of sexual assault in San Antonio? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-san-antonio`,
    languages: { en: `${SITE_URL}/sexual-assault-lawyer-san-antonio`, es: `${SITE_URL}/es/abogada-agresion-sexual-san-antonio` },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in San Antonio, TX",
    description:
    "Survivor of sexual assault in San Antonio? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-san-antonio`,
  },
};
...
export default function SanAntonioPage() {
  ...
  return (
    <PageShell dict={dict} locale="en">
      ...
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "San Antonio", url: "/sexual-assault-lawyer-san-antonio" }])} />
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.sanAntonio} alt="San Antonio area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in San Antonio</h3>
