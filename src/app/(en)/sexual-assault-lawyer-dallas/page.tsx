...
export const metadata: Metadata = {
  title: "Sexual Assault Lawyer in Dallas, TX",
  description:
    "Survivor of sexual assault in Dallas? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
  alternates: {
    canonical: `${SITE_URL}/sexual-assault-lawyer-dallas`,
    languages: {
      en: `${SITE_URL}/sexual-assault-lawyer-dallas`,
      es: `${SITE_URL}/es/abogada-agresion-sexual-dallas`,
    },
  },
  openGraph: {
    title: "Sexual Assault Lawyer in Dallas, TX",
    description:
    "Survivor of sexual assault in Dallas? Times Up stands with survivors against attackers and negligent institutions. Free, confidential consultation.",
    url: `${SITE_URL}/sexual-assault-lawyer-dallas`,
  },
};

export default function DallasPage() {
  const dict = getDictionary("en");
  const d = dict.cityPages.dallas;
  const cp = dict.cityPages;
  const routes = ROUTES.en;

  return (
    <PageShell dict={dict} locale="en">
      <JsonLd data={cityLegalServiceSchema("Dallas", "TX", "en")} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "/" }, { name: "Areas We Serve", url: "/areas-we-serve" }, { name: "Dallas", url: "/sexual-assault-lawyer-dallas" }])} />
      ...
      <section className="py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.cities.dallas} alt="Dallas, Texas" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12">
        <div className="mx-auto max-w-3xl px-4 flex justify-center">
          <Image src={IMAGES.maps.dallas} alt="Dallas area map" width={800} height={450} className="rounded-xl" />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10">
            <h3 className="text-xl font-bold text-brand-navy">Support Resources in Dallas</h3>
      ...
      <section className="bg-gray-50 py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="text-center text-3xl font-bold text-brand-navy">Survivor FAQ: Dallas</h2>
          <div className="mt-10">
      ...
      <NearbyAreas currentCity="dallas" locale="en" />
      ...
      <section className="bg-brand-cream py-16">
        <div className="mx-auto max-w-3xl px-4 text-center">
          ...
          <div className="mt-8">
            <a href={`tel:+1${PHONE_NUMBER}`} className="btn-lift btn-glow-coral inline-flex items-center gap-3 rounded-xl bg-brand-red px-10 py-4 text-lg font-bold text-white shadow-lg transition-colors hover:bg-brand-red-light">
