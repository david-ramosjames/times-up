...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Times Up.",
};

const content: LegalBlock[] = [
  {
    "type": "p",
    "text": "Times Up Law, PLLC (\"Times Up,\" \"Firm,\" \"we,\" \"us,\" or \"our\") respects your privacy and is committed to protecting the information you provide through our website, communications, and legal intake processes."
  },
  {
    "type": "p",
