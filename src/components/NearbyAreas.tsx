    ...
    <section className="bg-brand-navy py-16 text-white">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-center text-gray-300">
          {locale === "en"
            ? "Our attorneys represent survivors across Texas. Select a city to learn more."
            : "Nuestras abogadas representan a sobrevivientes en todo Texas. Seleccione una ciudad para más información."}
        </p>
