...
const STORAGE_KEY = "tu_review_modal_dismissed";
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md animate-[slideUp_0.3s_ease-out] rounded-2xl bg-white p-6 shadow-2xl md:p-8">
        ...
        <h3 className="text-center text-2xl font-extrabold text-gray-900">
          {isEn ? "Before You Go \u2014 A Confidential Conversation Is Free" : "Antes de Irte \u2014 Una Conversaci\u00f3n Confidencial Es Gratis"}
        </h3>
        ...
        <p className="mt-4 text-center text-gray-600">
          {isEn
            ? "Whenever you are ready, our woman-led team is here to listen \u2014 privately, without judgment, and at no cost."
            : "Cuando est\u00e9s lista, nuestro equipo dirigido por mujeres est\u00e1 aqu\u00ed para escucharte \u2014 en privado, sin juicios y sin costo."}
        </p>
        ...
        >
          ...
          <span className="lg:hidden">{isEn ? "Call Now — Confidential" : "Llamar Ahora — Confidencial"}</span><span className="hidden lg:inline">{isEn ? `Call Now: ${PHONE_DISPLAY}` : `Llame Ahora: ${PHONE_DISPLAY}`}</span>
        </a>
        ...
        <p className="mt-3 text-center text-xs font-medium text-gray-500">
          {isEn
            ...
            : "Gratis y confidencial \u2014 sin compromiso"}
        </p>
      </div>
    </div>
  );
