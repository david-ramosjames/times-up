...
export default function Footer({ dict, locale }: { dict: Dictionary; locale: Locale }) {
  ...
  // Social icons show only once real profile URLs are set (href !== "#")
  const socials = [
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <p className="text-xl font-bold">
              <span className="text-brand-coral">TIME&rsquo;S</span> UP
            </p>
            <p className="mt-2 text-sm text-gray-400">
              {isEn
                ? "Times Up — Justice for Survivors of Sexual Assault & Abuse"
                : "Times Up — Justicia para Sobrevivientes de Agresi\u00f3n y Abuso Sexual"}
            </p>
            ...
            {/* Social icons — shown once real profile URLs are set */}
            {socials.length > 0 && (
          ...
          <div>
            ...
            <nav className="space-y-2" aria-label="Case types">
              {[
                { href: routes.sexualAssault, label: isEn ? "Sexual Assault Lawyer" : "Abogada de Agresi\u00f3n Sexual" },
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href={routes.contact}
                  className="rounded-lg bg-brand-red-dark px-6 py-3 text-center font-bold text-white transition-colors hover:bg-[#5B21B6]"
                >
                  {dict.cta.freeReview}
                </Link>
              </div>
