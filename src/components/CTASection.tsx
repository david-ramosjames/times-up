    ...
    >
      <div className="mx-auto max-w-3xl px-4 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          ...
          <Link
            href={routes.contact}
            className="btn-lift flex w-full items-center justify-center gap-2 rounded-xl bg-brand-red-dark px-8 py-4 text-lg font-bold text-white transition-colors hover:bg-[#5B21B6] sm:w-auto"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
